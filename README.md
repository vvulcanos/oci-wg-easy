...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/oci/main/oci-wg-setup.sh -o setup.sh
chmod +x setup.sh
./setup.sh
```
...
```bash
# 대화형 설치
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/oci/main/install-wg-easy.sh | sudo bash

# 자동 설치
sudo bash <(curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/oci/main/install-wg-easy.sh) --auto
```
